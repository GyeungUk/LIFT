package com.lift.domain.ai.controller;

import com.lift.domain.ai.dto.request.AiChatMessageCreateReqDTO;
import com.lift.domain.ai.dto.request.AiMessageFeedbackCreateReqDTO;
import com.lift.domain.ai.dto.request.AiTermsAgreeReqDTO;
import com.lift.domain.ai.dto.response.AiChatMessageCreateResDTO;
import com.lift.domain.ai.dto.response.AiChatMessagesResDTO;
import com.lift.domain.ai.dto.response.AiChatRoomResDTO;
import com.lift.domain.ai.dto.response.AiMessageFeedbackCreateResDTO;
import com.lift.domain.ai.dto.response.AiSuggestedQuestionsResDTO;
import com.lift.domain.ai.dto.response.AiTermsAgreeResDTO;
import com.lift.domain.ai.dto.response.AiTermsStatusResDTO;
