package com.bodeum.domain.lifetransition.controller;

import com.bodeum.domain.lifetransition.dto.request.ReportChatMessageCreateReqDTO;
import com.bodeum.domain.lifetransition.dto.request.ReportPdfEstimateReqDTO;
import com.bodeum.domain.lifetransition.dto.request.TossPaymentConfirmReqDTO;
import com.bodeum.domain.lifetransition.dto.response.DocumentFetchResDTO;
import com.bodeum.domain.lifetransition.dto.response.LatestChatReportResDTO;
import com.bodeum.domain.lifetransition.dto.response.LatestReportRouteResDTO;
import com.bodeum.domain.lifetransition.dto.response.LifeReportResDTO;
import com.bodeum.domain.lifetransition.dto.response.ReportChatMessageCreateResDTO;
import com.bodeum.domain.lifetransition.dto.response.ReportChatMessagesResDTO;
import com.bodeum.domain.lifetransition.dto.response.ReportPaymentResDTO;
import com.bodeum.domain.lifetransition.dto.response.ReportPreviewResDTO;
import com.bodeum.domain.lifetransition.service.LifeDocumentFetchService;
import com.bodeum.domain.lifetransition.service.LifeReportChatService;
import com.bodeum.domain.lifetransition.service.LifeReportService;
